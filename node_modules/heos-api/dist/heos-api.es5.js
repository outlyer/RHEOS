...
function createHeosSocket(address, responseParser) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        try {
            var socket_1 = createConnection({ port: port, host: host, localPort: 0 }, function () {
...
export { discoverDevices, discoverOneDevice, discoverAndConnect, connect };
//# sourceMappingURL=heos-api.es5.js.map
